...
// résultat attendue 649 caractères (J'ai formate le texte c'est pour cela que je trouve pas pareille)
let txt1 = 'Je suis le ténébreux, - le veuf, - l\'inconsolé,\n\
...
console.log(`Ce texte contient ${txt1.length} charactères`)